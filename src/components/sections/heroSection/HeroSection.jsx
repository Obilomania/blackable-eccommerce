...
const HeroSection = () => {
  return (
    <div className="relative top-0 left-0 w-full h-[100vh] overflow-hidden heroSection bg-black">
      <div className="heroContent flex items-center gap-[4%]">
        <div className="left text-white w-[72%] flex flex-col items-start gap-5 justify-start">
          <h1 className="text-[4.2rem] font-bold">Best Fashion Collection</h1>
